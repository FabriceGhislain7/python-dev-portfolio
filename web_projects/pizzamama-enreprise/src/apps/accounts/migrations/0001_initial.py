# Generated by Django 5.0.1 on 2025-07-22 00:25
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('preferred_language', models.CharField(choices=[('it', 'Italiano'), ('en', 'English')], default='it', max_length=5)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('label', models.CharField(help_text='es. Casa, Ufficio, Altro', max_length=50)),
                ('street_address', models.CharField(max_length=200)),
                ('city', models.CharField(max_length=100)),
                ('postal_code', models.CharField(max_length=10)),
                ('province', models.CharField(max_length=50)),
                ('country', models.CharField(default='Italia', max_length=50)),
